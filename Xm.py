...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +8801977073308")
	subprocess.check_output(["am", "start", "https://wa.me/+8801977073308"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/DEVIL-NAJMUL/Xm/blob/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
